...
y=pipe.predict(pd.DataFrame([['Chevrolet','aveo',2018,' Automatic',2000, 4,' Petrol',8,10000]],columns=['Brand','Model','Model_year','Transmission','Engine_size(cc)','Drivetrain','Fuel_type','Lot_no','Kilometer']))
print(y)
...
#sns.set_style('white')
#sns.set_style('ticks')
#sns.regplot(x='Price', y='Engine_size(cc)',data=car)

...
lr_model=pickle.load(open(r'C:\Users\rabin\Desktop\Finest\Minorproject\static\model\finalmodel.pickle','rb'))
car=pd.read_csv(r'C:\Users\rabin\Desktop\Finest\Minorproject\static\datasets\data.csv')
